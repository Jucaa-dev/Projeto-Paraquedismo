...
router.post('/', validate(), cursoController.adicionarcurso);//Rota final: POST/api/cursos
...
router.get('/:id', cursoController.listarcursoCpf); //Rota final: GET/ api/cursos/:cpf
