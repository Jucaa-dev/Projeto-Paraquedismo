...
router.post('/', validate(), clienteController.adicionarCliente);//Rota final: POST/api/clientes
...
router.get('/', clienteController.listarCliente); //Rota final: GET / api/clientes
